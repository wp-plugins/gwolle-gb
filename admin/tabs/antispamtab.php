				...
				<div>
					...
					if ( class_exists('ReallySimpleCaptcha') ) { ?>
						<span class="setting-description">
							...
							<br /><br />
							<?php _e('Take note: If you use any caching plugin then it is strongly recommended to disable caching for your guestbook page. Otherwise the CAPTCHA might work with errors inside cached pages.', 'gwolle-gb'); ?>
						</span>
						<?php
					} else { ?>
						<span class="setting-description">
