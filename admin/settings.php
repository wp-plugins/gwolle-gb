			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						...
						?>
								<input name="notify_by_mail" type="checkbox" id="notify_by_mail" <?php if (get_option('gwolle_gb-notifyByMail-' . $current_user->data->ID) == 'true') { $currentUserNotification = true; echo 'checked="checked"'; } ?>>
